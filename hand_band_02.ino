...
void setup() {
  ...
  if(Firebase.RTDB.getFloat(&fbdo, "/hand_band/hand band 2/distance")){
...
void loop() {
  ...
  if (Firebase.RTDB.setInt(&fbdo, "hand_band_beacon/hand band 2/inzone", inzone)){
